...
export const WEAPON_MODEL_MAP: Record<number, string> = {
  ...
  39: "rif_sg556.glb",       // SG 553
  40: "ssg08.glb",           // SSG 08
  60: "m4a1s.glb",           // M4A1-S
  61: "pist_usp_silencer.glb", // USP-S
  63: "cz75a.glb",           // CZ75-Auto
  64: "revolver.glb",        // R8 Revolver
  // Knives - these don't have models yet, will use fallback
